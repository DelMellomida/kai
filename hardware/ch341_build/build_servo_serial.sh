#!/bin/bash
# Compile servo_serial.ino and upload to Arduino via avrdude
set -e
...
SKETCH="/home/devconph/Documents/kai/arduino/servo_serial/servo_serial.ino"
BUILD="/tmp/servo_serial_build"
...
echo "=== Building servo_serial for Arduino $BOARD ==="
...
echo ""
if [ ! -e "$PORT" ]; then
    echo "ERROR: $PORT not found. Run: sudo bash fix_usb.sh"
    exit 1
fi
...
echo ""
echo "Upload done. Now run:"
echo "  sudo python3 /home/devconph/Documents/face-servo/servo_serial.py --sweep"
